...
//        echo 'WD: '.date('N-m-d',$workingDate).'<br/>';
        $minCell = new minimalCellCreator();
        for ($i = 0; $i < 7; $i++) {
    ...
    private function _createNavi()
    {
        ...
        return
            '<div class="header">' .
            '<a class="prev" href="prototypeMonth.php?month=' . sprintf('%02d', $this->currentMonth) . '&year=' . $this->currentYear . '">Back Up To Month</a>' .
            '<span class="title">WEEKLY VIEW</span></div>';
    }
